...
(function() {
    ...
    CustomEvents = (function() {
        ...
        CustomEvents.fire = function(element, eventName) {
            var event;
            if (element.addEventListener) {
    ...
    LiveReload = (function() {
            ...
            this.connector = new Connector(this.options, this.WebSocket, Timer, {
                ...
                message: function(message) {
                    switch (message.command) {
                        ...
                        case 'url':
                            return _this.performURL(message);
                        case 'plugin':
                            return _this.performPlugin(message);
                    }
                }
            });
        }
        ...
        LiveReload.prototype.performURL = function(message) {
            return document.location = message.url;
        };

        LiveReload.prototype.performPlugin = function(message) {
            return this.processPluginCommand(message);
        };
        ...
        LiveReload.prototype.processPluginCommand = function(message) {
    ...
    var LiveReloadPluginSocket, SocketPlugin,
    ...
    SocketPlugin = (function() {
        ...
        function SocketPlugin(window, host) {
            this.window = window;
            this.host = host;
        ...
        SocketPlugin.prototype.sendCommand = function(msg) {
            return this.host._connector.sendCommand(msg);
        };

        SocketPlugin.prototype.analyze = function() {
            return {
                disable: false
            };
        };
    ...
    LiveReloadPluginLess = window.LiveReloadPluginLess = LessPlugin;
